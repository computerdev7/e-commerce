...
export default function UserOrder() {
    ...
    function orderIsNotAvailable(id) {
        axios.delete(`http://localhost:3000/userorder/notavailable?id=${id}`, {
            withCredentials: true
        })
    ...
    function returnOrder(id, refundFeedback) {
    ...
    function giveOrderToDelivery(id) {
    ...
    console.log(orders, refundFeedback)

    let renderOrders = orders?.map((e, i) => {
        ...
        return (
            <>
                <div className="min-h-60 w-full border border-b">
                    <div className="h-40 border-b p-1 flex w-full">
