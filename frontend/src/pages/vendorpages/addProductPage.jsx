                ...
                <div className="flex w-full justify-center items-center flex-col gap-2 p-5">
                    ...
                    <div className="w-full flex justify-between items-center">
                        ...
                        <button disabled={showLoading ? true : false} className="border border-b p-2 w-32 disabled:border-gray-500 disabled:text-gray-600"
                            onClick={() => {
                                addProduct(formData.productName, formData.productPrice, formData.category, formData.subCategory, formData.desc, shortDetailInput, longDetailInput, numberOfImages.current, formData.quantity)
                                    .then(res => {
